            ...
            <div class="query-result-table m10-b">
                <table width="100%" class="table">
                    ...
                    <tr>
                        ...
                        <td>${list.lock}</td>
                        <td>
                        <input type="button"  value="逻辑删除"  class="btn-orange1"  onclick="logicDel('${list.uid}')"/>
...
<script type="text/javascript">
      ...
      function  logicDel(uid){
          loadPageForPost('<%=path%>/user/execUpdate.do?ctx=logicDel',{uid:uid});
      }
