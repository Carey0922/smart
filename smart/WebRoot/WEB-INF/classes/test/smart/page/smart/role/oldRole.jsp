            ...
            <div class="query-result-table m10-b">
                <table width="100%" class="table">
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="button"  value="恢复角色"  class="btn-orange1"  onclick="restore('${list.rid}')"/>
...
<script type="text/javascript">
      ...
      function  restore(rid){
          loadPageForPost('<%=path%>/role/execUpdate.do?ctx=restore',{rid:rid});
      }
      ...
      function ShowRoleInfo(id) {
          $.ajax({
              url: '<%=path%>/role/getUserInfo.do?rid='+id+'&next=roleInfo',
              success: function (data) {
                  $("#bodyInfo").html(data);
              },
              cache: false
